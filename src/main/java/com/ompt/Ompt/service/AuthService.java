...
public class AuthService {
  ...
  public void register(RegisterRequestDTO request) {
    ...
    Long doctorId = request.getDoctorAssignedId();
    patientRecordService.createForNewPatient(user, doctorId);
  }
  ...
  public void setPassword(String token, String newPassword) {
    ...
    List<User> users =
        userRepository.findByResetTokenHashIsNotNullAndResetTokenExpiryAfter(LocalDateTime.now());
