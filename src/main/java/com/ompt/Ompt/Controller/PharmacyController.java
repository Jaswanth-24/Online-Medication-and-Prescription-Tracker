...
public class PharmacyController {
  ...
  public ResponseEntity<PharmacyProfileDTO> updateProfile(
      Authentication authentication, @Valid @RequestBody PharmacyProfileUpdateDTO request) {
  ...
  public ResponseEntity<InventoryItemResponseDTO> createInventoryItem(
      Authentication authentication, @Valid @RequestBody InventoryItemRequestDTO request) {
    return ResponseEntity.status(HttpStatus.CREATED)
        .body(pharmacyService.createInventoryItem(authentication.getName(), request));
  }
  ...
  public ResponseEntity<DeliveryResponseDTO> createDelivery(
      Authentication authentication, @Valid @RequestBody DeliveryRequestDTO request) {
    return ResponseEntity.status(HttpStatus.CREATED)
        .body(pharmacyService.createDelivery(authentication.getName(), request));
  }
